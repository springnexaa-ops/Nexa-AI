...
export function cookieToken(request:Request):string|null { const cookies=request.headers.get("cookie")||"";const m=cookies.match(/(?:^|;\s*)__Host-nexa_admin=([^;]+)/);return m?decodeURIComponent(m[1]):null; }
