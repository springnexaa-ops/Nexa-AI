...
body.nexaKashmir .nxNew{background:linear-gradient(135deg,var(--jk-sky-deep),#286e98)!important;box-shadow:0 7px 18px rgba(60,159,200,.16)!important}
...
body.nexaKashmir .nxNav.on{background:linear-gradient(90deg,rgba(115,199,232,.23),rgba(36,88,68,.07))!important;border-color:rgba(60,159,200,.18)!important;color:var(--jk-ink)!important}
